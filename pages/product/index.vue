...
import { IProductSearchParams, IProductSearchResponse, defaultSearchResponse } from '~/utils/interfaces/crudObjects';
...
methods: {
   async searchProduct(){
    this.isLoading = true    
    await this.$axios.get<defaultSearchResponse<IProductSearchResponse>>('/product/search', {
      params: {
  ...
  .catch((error) => {
    ...
    async deleteProduct(){
      await this.$axios.put('/product/delete/' + this.itemIdToDelete, {    
