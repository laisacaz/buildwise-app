        ...
        <v-form v-if="isReportOn">
                ...
                max-width="600px">
                    ...
                    elevation="3">
                        ...
                        <v-card-subtitle class="mt-4" style="font-size:18px">Gera relatório ordenado por produtos mais vendidos</v-card-subtitle>
...
export default Vue.extend({
  ...
  methods: {
    ...
    async generatePdf(){
        ...
        await this.$axios.get<Blob>('/report/product-ranking', {
