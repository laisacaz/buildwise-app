      ...
      <v-form v-if="isReportOn">
              ...
              max-width="600px">
                  ...
                  elevation="3">
                      ...
                      <v-card-subtitle class="mt-4" style="font-size:18px">Gera relatório de vendas de acordo com o período selecionado:</v-card-subtitle>
...
methods: {
  ...
  async generatePdf(){
      ...
      await this.$axios.get<Blob>('/report/sale-by-period', {
        params: this.filters,
